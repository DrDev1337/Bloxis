...
(function (global) {
  ...
  var LEVELS = [
    ...
    { // 6 – trappa
      type: 'score', target: 1100, moves: 26, board: [
        '#.......','##......','###.....','####....',
        '........','........','........','........'
      ]
    },
    { // 7 – stengärdet
      type: 'score', target: 1000, moves: 26, board: [
        '........','........','..##....','........',
        '........','....##..','........','........'
      ]
    },
    ...
    { // 9 – ram
      type: 'score', target: 1200, moves: 28, board: [
        '.######.','#......#','#......#','#......#',
        '#......#','#......#','#......#','.######.'
      ]
    },
    ...
    { // 15 – stenmuren
      type: 'score', target: 1400, moves: 30, board: [
        '........','........','........','..####..',
        '..####..','........','........','........'
      ]
    },
    ...
    { // 18 – pelare
      type: 'score', target: 1500, moves: 30, board: [
        '#......#','#......#','#......#','........',
        '........','#......#','#......#','#......#'
      ]
    },
    ...
    { // 23 – snöstormen
      type: 'score', target: 1600, moves: 32, board: [
        '#......#','........','........','...##...',
        '...##...','........','........','#......#'
      ]
    },
    { // 24 – labyrint
      type: 'score', target: 1800, moves: 34, board: [
        '........','###..###','........','........',
        '........','........','###..###','........'
      ]
    },
    ...
    { // 43 – färgjakt: ljusblå nebulosa
      type: 'collect', color: 4, count: 14, moves: 36, board: [
        '#......#','........','........','...II...',
        '...II...','........','........','#......#'
      ]
    },
    ...
    { // 45 – supernovan
      type: 'score', target: 2200, moves: 38, board: [
        '........','..I..I..','........','...##...',
        '...##...','........','..I..I..','........'
      ]
    },
    ...
    { // 51 – lavaklipporna
      type: 'score', target: 2100, moves: 36, board: [
        '##....##','#......#','........','........',
        '........','........','#......#','##....##'
      ]
    },
    ...
    { // 69 – trollstigen
      type: 'score', target: 2200, moves: 36, board: [
        '........','.##.....','.##.....','........',
        '........','.....##.','.....##.','........'
      ]
    },
